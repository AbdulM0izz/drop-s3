...
var _Upload = class _Upload extends import_events.EventEmitter {
  constructor(options) {
    ...
    __publicField(this, "partSize", _Upload.MIN_PART_SIZE);
  ...
  async __uploadUsingPut(dataPart) {
    ...
    const resolved = await Promise.all([this.client.send(new PutObjectCommand(params)), (_a = clientConfig == null ? void 0 : clientConfig.endpoint) == null ? void 0 : _a.call(clientConfig)]);
